Ext.define('MyDesktop.app.views.ContratoHonorario', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.wcontratohonorario',
    id: 'wcontratohonorario',
    requires: [
    ...
    initComponent: function () {
        storecontratos = Ext.create('MyDesktop.app.stores.ContratosHonorarios');
            ...
            tbar: [
                {
                    ...
                    text: 'Nuevo',
                    iconCls: 'add',
                    id: 'btnNuevoContratohonorario',
                    handler: function (btn) {

                        var frm = Ext.create('MyDesktop.app.views.ContratoEditarHonorario',{animateTarget: btn.id});
                ...
                '-',
                {
                    ...
                    handler: function (btn) {
                       ...
                       // alert("asasa");
                        ...
                        var frm = Ext.create('MyDesktop.app.views.ContratoModificarHonorario', conf);
                        frm.show(this, function () {
                        });
                ...
                '-',
                {
                    ...
                    text: 'Anular',
                    iconCls: 'remove',
                    id: 'btnEliminarContratohonorario',
                    disabled: true,
                    handler: function () {
                        var grid = Ext.getCmp('dgvContratoshonorarios');
                        var selectedRecord = grid.getSelectionModel().getSelection()[0];
                                        ...
                                        success: function (conn, response, options, eOpts) {
                                            ...
                                            if (result.success) {
                                                Ext.each(result.items, function (item) {
                                                    if (item.ERROR > 0) {
                                                        Ext.getCmp('dgvContratoshonorarios').getStore().reload();
                                                    }
                ...
                '-',
                {
                    ...
                    iconCls: 'boton-print',
                    disabled: true,
                    id: 'btnImprimirContratohonorario',
                    handler: function () {
                ...
                '-',
                {
                    ...
                    iconCls: 'icon-grid',
                    id: 'btnActualizarContratoshonorario',
                    handler: function () {
                        var grid = Ext.getCmp('dgvContratoshonorarios');
                ...
                },
                {
                    ...
                    iconCls: 'icon-grid',
                    disabled: true,
                    id: 'btnContratoAsignarBobinahonorario',
                    handler: function (btn) {
                        var grid = Ext.getCmp('dgvContratoshonorarios');
                        var selectedRecord = grid.getSelectionModel().getSelection()[0];
                ...
                },
                {
                    ...
                    iconCls: 'icon-grid',
                    disabled: true,
                    id: 'btnContratoRegistroSalidahonorario',
                    handler: function (btn) {
                        var grid = Ext.getCmp('dgvContratoshonorarios');
                        var selectedRecord = grid.getSelectionModel().getSelection()[0];
                ...
                '-',
                {
                    ...
                    fieldLabel: 'Desde',
                    allowBlank: true,
                    id: 'dpFechaContratoDesdehonorario',
                    flex: 0.5,
                    labelWidth: 90,
                ...
                },
                {
                    ...
                    fieldLabel: 'Hasta',
                    allowBlank: true,
                    id: 'dpFechaContratoHastahonorario',
                    flex: 0.5,
                    labelWidth: 90,
                    labelAlign: 'right',
                    plugins: [new Ext.ux.desktop.InputTextMask('99/99/9999')],
                ...
                },
                {
                    xtype: 'button',
                    iconCls: 'x-ico-lupa',
                    id: 'btnBuscarRangoFechashonorario',
                    handler: function () {
                        filtrarGrillahonorario(-3, null);
                    }
                }
            ]
        });
...
//    },
    ...
    grillaBotonesEstado: function (_estado, _pagado,_tipodoc) {
        ...
        switch (parseInt(_estado)) {
            ...
            case 1: // Registrado
                Ext.getCmp('btnEliminarContratohonorario').setDisabled(false);
                Ext.getCmp('btnNuevoContratohonorario').setDisabled(false);
                Ext.getCmp('btnEditarContratohonorario').setDisabled(false);
                Ext.getCmp('btnImprimirContratohonorario').setDisabled(true);
                Ext.getCmp('btnContratoAsignarBobinahonorario').setDisabled(false);
                if (_pagado != '') {
                    Ext.getCmp('btnContratoRegistroSalidahonorario').setDisabled(false);
                } else {
                    Ext.getCmp('btnContratoRegistroSalidahonorario').setDisabled(false);
                }
                ;
            ...
            case 2: // Cancelado => estado cuando se cobro el trabajo
                ...
                Ext.getCmp('btnNuevoContratohonorario').setDisabled(false);
                Ext.getCmp('btnEditarContratohonorario').setDisabled(false);
                Ext.getCmp('btnImprimirContratohonorario').setDisabled(false);
                Ext.getCmp('btnContratoAsignarBobinahonorario').setDisabled(false);
                Ext.getCmp('btnContratoRegistroSalidahonorario').setDisabled(true);


                break;
            case 4: // Eliminado
                Ext.getCmp('btnEliminarContratohonorario').setDisabled(true);
                Ext.getCmp('btnNuevoContratohonorario').setDisabled(false);
                Ext.getCmp('btnEditarContratohonorario').setDisabled(true);
                Ext.getCmp('btnImprimirContratohonorario').setDisabled(true);
                Ext.getCmp('btnContratoAsignarBobinahonorario').setDisabled(false);
                Ext.getCmp('btnContratoRegistroSalidahonorario').setDisabled(true);
                ;
...
function filtrarGrillahonorario(_tipo, _valor) {
    if (_tipo == -2) {
    ...
    if (_tipo == -3) { /*Rango por fechas*/
        ...
        storecontratos.getProxy().extraParams = {
            ...
            pcliente: null,
            pestado: 0,
            pdesde: Ext.getCmp('dpFechaContratoDesdehonorario').getValue(),
            phasta: Ext.getCmp('dpFechaContratoHastahonorario').getValue(),
            psede : Ext.util.Cookies.get('sede')
        };
        storecontratos.loadPage(1);
        return false;
