...
Ext.define('MyDesktop.app.views.ContratoEditar', {
  extend : 'Ext.window.Window',
  alias : 'widget.wcontratoeditar',
  id : 'wcontratoeditar',
  itemId : 'wcontratoeditar',
  width : 650,
  height : 830,
  modal : true,
  floating : true,
              ...
              items : [
                {
                  ...
                  items : [
                    ...
                    {xtype : 'hiddenfield', id : 'txtIdNotaPedido',itemId : 'txtIdNotaPedido',  value : 0},
                    {
                      xtype : 'textfield',
                      id : 'txtDatosPersona',
                      itemId : 'txtDatosPersona',
              ...
              items : [
                ...
                },
                {
                  ...
                  items : [
                    ...
                    {
                      xtype : 'numberfield',
                      fieldLabel : 'Saldo a Cobrar ',
                      itemId : 'txtSaldoCobrar',
                      name : 'saldoconbrar',
                      value : 0,
                      decimalPrecision : 3,
                      minValue : 0,
 ...
 //       Ext.getCmp('txtPrecioventa').getValue() == null)
  ...
  ActualizarContrato : function(btn) {
    ...
    if(__tipoDoc == 'RH'){
        ...
        {
          Ext.Msg.alert("Ingrese el numero del recibo por horario","Aviso");
    ...
    Ext.ComponentQuery.query('#wcontratoeditar')[0].mask('..enviando');
    ...
    Ext.Ajax.request({
      ...
      params : {
        ...
        ppersona :  Ext.ComponentQuery.query('#txtDatosPersona')[0].getValue(),    // Ext.getCmp('txtDatosPersona').getValue(),
        ...
        ptipodoc : __tipoDoc,
        pidper :  Ext.ComponentQuery.query('#txtIdPersona')[0].getValue(),     //Ext.getCmp('txtIdPersona').getValue(),
          ...
          Ext.each(result.items, function(item) {
            if (item.ERROR < 0) {
              ...
              console.log("Llego a ActualizarContratoDetalle " +
                          item.ERROR.toString());
              ActualizarContratoDetalle(item.ERROR, storedetallecontrato);
...
function ActualizarContratoDetalle(_idcontrato, _store) {
  ...
  fx_ContratoGuardarDetalleReg(_idcontrato, idproductos, cantidades, medidas1,
                               medidas2, totales, idmateriales, bobinas,
                               operarios, obseritem, textoitem);
}
function fx_ContratoGuardarDetalleReg(
      ...
      if (result.success) {
        Ext.each(result.items, function(item) {
          ...
          if (parseInt(item.ERROR) > 0) {
            ...
            Ext.getCmp('wcontratoeditar').close();
            return true;
          }
