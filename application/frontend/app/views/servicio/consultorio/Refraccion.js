...
Ext.define('MyDesktop.app.views.servicio.consultorio.Refraccion',{
            ...
            items: [
                {
                    ...
                    tbar: [
                        {
                            xtype : 'button',
                            id : 'btnRefraccionAgregarOD',
                            text : 'Agregar',
                            iconCls : 'add'
                       },
                        {
                            xtype : 'button',
                            id : 'btnRefraccionEliminarOD',
                            text : 'Eliminar',
                            iconCls : 'remove'
                        }
                ...
                },
                {
                    ...
                    tbar: [
                        {
                            xtype : 'button',
                            id : 'btnRefraccionAgregarOI',
                            text : 'Agregar',
                            iconCls : 'add'
                        },
                        {
                            xtype : 'button',
                            id : 'btnRefraccionEliminarOI',
                            text : 'Eliminar',
                            iconCls : 'remove'
                        }
