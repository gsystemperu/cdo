...
Ext.define('MyDesktop.app.views.consulta.LenteContacto2',{
    extend : 'Ext.panel.Panel',
    config:{
        id:0
    },
    alias : 'widget.lentecontactoingreso2',
    id : 'lentecontactoingreso2',
    requires: [
            ...
            items: [
                {
                    ...
                    items : [
                        {
                            border: false,
                            xtype: 'gridpanel',
                            id   : 'dgvLenteContactoOjoDerecho2',
                    ...
                    tbar: [
                        {
                            xtype : 'button',
                            id : 'btnLenteContactoAgregarOD2',
                            text : 'Agregar',
                            iconCls : 'add'
                        },
                        {
                            xtype : 'button',
                            id : 'btnLenteContactoEliminarOD2',
                            text : 'Eliminar',
                            iconCls : 'remove'
                        }
                ...
                },
                {
                    ...
                    items : [
                        {
                            border: false,
                            xtype: 'gridpanel',
                            id   : 'dgvLenteContactoOjoIzquierdo2',
                    ...
                    tbar: [
                        {
                            xtype : 'button',
                            id : 'btnLenteContactoAgregarOI2',
                            text : 'Agregar',
                            iconCls : 'add'
                        },
                        {
                            xtype : 'button',
                            id : 'btnLenteContactoEliminarOI2',
                            text : 'Eliminar',
                            iconCls : 'remove'
                        }
