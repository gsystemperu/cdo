...
Ext.define('MyDesktop.app.views.consulta.ConsultaHistoriaPaciente', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.wconsultahiostoriapaciente',
    id: 'wconsultahiostoriapaciente',
    config: {id: 0},
    requires: [
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype: 'datepicker',
                                    id: 'dtfechacitaConsulta_consulta',
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    title: 'Pacientes',
                                    id: 'dgvpacientesprogramados_consulta',
                                    itemId: "dgvpacientesprogramados_consulta",
                                    store: storepaciente,
...
//                                        }
                            ...
                            tbar: [
                                {
                                    xtype: "textfield",
                                    fieldLabel: "Paciente",
                                    id: "txtbuscar_consultahistoriapaciente",
                                ...
                                },
                                {
                                    xtype: "button",
                                    text: "Buscar",
                                    id: "btnbuscar_consultahistoriapaciente",
                                    iconCls: "x-ico-lupa"
                                },
                                {
                                    xtype: "button",
                                    text: "Limpiar",
                                    id: "btnrefrescar_consultahistoriapaciente",
                                ...
                                },
                                {
                                    xtype: 'combobox',
                                    hidden: true,
                                    id: 'cboMedicoConsultorio_consulta',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'panel',
                            id: "panelRegistroDeAtenciones_consulta",
                            flex: 1,
                            autoScroll: true,
                            layout: {type: 'fit'},
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'dgvatencionespaciente_consulta',
                                    itemId: "dgvatencionespaciente_consulta",
                                    store: storeHisAtenciones_consulta,
                                    sortableColumns: false,
                                    columns:
                                            [
                                                {
                                                    text: 'Fecha',
                                                    dataIndex: '_fechacita',
                                                    flex: 0.6
                                    ...
                                    ,
                                    listeners: {
                                        select: function (grid, record, index, opc) {
//                                            __editar = 0;
//                                            __idConsultorio = 0;

                                            //    Ext.ComponentQuery.query("diagnosticoingreso2 #dfDiagnosticoProximaCita2")[0].setRawValue("01/02/1980");



//                                            if (record.get('_estado') == '5') {
//                                                Ext.getCmp('btnImprimirDiagnostico_consulta').setDisabled(false);
//                                                Ext.getCmp('btnImprimirLenteContacto_consulta')
//                                                        .setDisabled(false);
//                                                Ext.getCmp('btnImprimirDiagnostico_A4_consulta').setDisabled(false);
//                                                Ext.getCmp('btnImprimirLenteContacto_A4_consulta')
//                                                        .setDisabled(false);
//                                                Ext.getCmp('btnEditarFichaAtencion_consulta').setDisabled(false);
//
//                                                Ext.ComponentQuery.query("diagnosticoingreso2 #dfDiagnosticoProximaCita2")[0].setReadOnly(false);
//                                                Ext.ComponentQuery.query("diagnosticoingreso2 #checkdiagnosticoProximacita2")[0].setVisible(false);
//                                            }else {
//                                                Ext.getCmp('btnImprimirDiagnostico_consulta').setDisabled(true);
//                                                Ext.getCmp('btnImprimirLenteContacto_consulta')
//                                                        .setDisabled(true);
//                                                Ext.getCmp('btnImprimirDiagnostico_A4_consulta').setDisabled(true);
//                                                Ext.getCmp('btnImprimirLenteContacto_A4_consulta')
//                                                        .setDisabled(true);
//                                                Ext.getCmp('btnEditarFichaAtencion_consulta').setDisabled(true);
//
...
//                                                console.log("Mi objeto :"+ Ext.ComponentQuery.query("diagnosticoingreso2")[0]);
//                                                
//                                                Ext.ComponentQuery.query("diagnosticoingreso2 #dfDiagnosticoProximaCita2")[0].setRawValue(fecha);
//                                                Ext.ComponentQuery.query("diagnosticoingreso2 #dfDiagnosticoProximaCita2")[0].setReadOnly(true);
//                                                Ext.ComponentQuery.query("diagnosticoingreso2 #checkdiagnosticoProximacita2")[0].setValue(true);
//                                                Ext.ComponentQuery.query("diagnosticoingreso2 #checkdiagnosticoProximacita2")[0].setVisible(true);
//
//                                            }
                                            ...
                                            var me = Ext.getCmp("wconsultahiostoriapaciente");
                            ...
                            tbar: [
                                {
                                    ...
                                    id: 'btnGuardarFichaAtension_consulta',
                                    hidden: true
                                ...
                                {
                                    xtype: 'button',
                                    id: 'btnImprimirDiagnostico_consulta',
                                ...
                                {
                                    xtype: 'button',
                                    id: 'btnImprimirDiagnostico_A4_consulta',
                                ...
                                {
                                    xtype: 'button',
                                    id: 'btnImprimirLenteContacto_consulta',
                                    text: '<b>Refracción<b>',
                                    iconCls: 'boton-print',
                                    disabled: false,
                                    hidden: true
                                ...
                                '-',
                                   {
                                    xtype: 'button',
                                    id: 'btnImprimirLenteContacto_A4_consulta',
                                ...
                                {
                                    xtype: 'button',
                                    id: 'btnEditarFichaAtencion_consulta',
                                ...
                                {
                                    xtype: 'button',
                                    id: 'btnCancelarAtencion_consulta',
                                    text: '<b>Cancelar<b>',
...
//                                }
                            ...
                            items: [
                                {
                                    xtype: 'tabpanel',
                                    id: 'myTabPanel_consulta',
                                    activeTab: 0,
                                    items: [
                                        {
                                            xtype: 'panel',
                                            title: 'Refraccion',
                                            id: 'tabRefraccion_consulta',
                                            layout: 'fit',
                                            padding: 5,
                                            items: [
                                                {
                                                    xtype: "tabpanel",
                                                    id: "myTabPanelrefraccion_consulta",
                                                    activeTab: 0,
                                                    items: [
                                                        {
                                                            xtype: "panel",
                                        ...
                                        },
                                        {
                                            ...
                                            padding: 5,
                                            items: [{xtype: 'biomicroscopiaingreso2'}]
                                        },
                                        {
                                            xtype: 'panel',
                                            title: 'Oftalmoscopia',
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    items: [
                                                        {
                                                            xtype: 'oftalmoscopiaingreso2_1',
                                                            title: "OD"
                                                        },
                                                        {
                                                            xtype: "oftalmoscopiaingreso2_2",
                                                            title: "OI"
                                                        }
                                                    ]
...
//                              ]
                                        },
                                        {
                                            ...
                                            layout: 'fit',
                                            padding: 5,
                                            items: [{xtype: 'diagnosticoingreso2'}]
                                        },
                                        {
                                            xtype: 'panel',
                                            title: 'Otros',
        ...
        Ext.getCmp("btnbuscar_consultahistoriapaciente").on("click", me.accionBuscarPaciente, this);
        Ext.getCmp("txtbuscar_consultahistoriapaciente").on("keypress", me.accionEnterBuscarPaciente, this);
        Ext.getCmp("btnrefrescar_consultahistoriapaciente").on("click", me.accionRefrescarPaciente, this);



        //  Ext.getCmp("dgvatencionespaciente_consulta").on("itemclick", me.accionclickgrillaatencionesPacienteConsulta_onItemClick, this);
...
//    accionclickgrillaatencionesPacienteConsulta_onItemClick: function (grid, record, item, index, e, eOpts) {
//
//        var fecha = record.data._fechacita;
//        var arreglofecha = fecha.split("/");
//        fecha = arreglofecha[0] + "/" + arreglofecha[1] + "/" + (parseInt(arreglofecha[2]) + 1);
//
//        console.log("mi fecha:" + fecha);
//        console.log("Mi objeto :" +  Ext.getCmp("dfDiagnosticoProximaCita2"));
//
//       // Ext.ComponentQuery.query("diagnosticoingreso2 #dfDiagnosticoProximaCita2")[0].setRawValue(fecha);
//    },
    accionEnterBuscarPaciente: function (field, e, eOpts) {
        if (e.getKey() == e.ENTER) {
            var cadena = Ext.getCmp("txtbuscar_consultahistoriapaciente").getValue();
            var store = Ext.getCmp('dgvpacientesprogramados_consulta').getStore();
            store.removeAll();
            store.load({
                params: {
                    opcion: 1,
            ...
            Ext.getCmp("txtbuscar_consultahistoriapaciente").focus();
        }
    },
    accionRefrescarPaciente: function (btn, e, opc) {
        Ext.getCmp("txtbuscar_consultahistoriapaciente").reset();
        var store = Ext.getCmp('dgvpacientesprogramados_consulta').getStore();
        store.removeAll();
        store.load({
            params: {
    ...
    accionHistorialAtencionesPaciente: function (obj, record, item, index, e) {
        ...
        store.getProxy().extraParams = {vidpaciente: record.get('_idper')};
        store.load();
