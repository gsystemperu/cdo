...
Ext.define('MyDesktop.app.views.ContratoEditarHonorario', {
  extend : 'Ext.window.Window',
  alias : 'widget.wcontratoeditarhonorario',
  id : 'wcontratoeditarhonorario',
  width : 650,
  height : 780,
  modal : true,
  floating : true,
  autoShow : false,
  title : '.:.  Registro Recibo Honorario  .:.',
  bodyPadding : 5,
  requires : [
  ...
  //storedisenio = Ext.create('MyDesktop.app.stores.Diseniadores');
          ...
          Ext.each(result.items, function(item) {
            if (item.ERROR < 0) {
              ...
              console.log("Llego a ActualizarContratoDetalle " +
                          item.ERROR.toString());
              ActualizarContratoDetalleHonorario(item.ERROR, storedetallecontrato);
            }
...
function ActualizarContratoDetalleHonorario(_idcontrato, _store) {
  ...
  fx_ContratoGuardarDetalleRegHonorario(_idcontrato, idproductos, cantidades, medidas1,
                               medidas2, totales, idmateriales, bobinas,
                               operarios, obseritem, textoitem);
}
function fx_ContratoGuardarDetalleRegHonorario(
      ...
      if (result.success) {
        Ext.each(result.items, function(item) {
          ...
          if (parseInt(item.ERROR) > 0) {
            ...
            Ext.getCmp('wcontratoeditarhonorario').close();
            return true;
          }
