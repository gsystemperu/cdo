...
Ext.define("MyDesktop.app.views.ContratoModificar", {
  ...
  alias : 'widget.contratomodificar',
  width : 650,
  height : 830,
  modal : true,
                ...
                },
                {
                  ...
                  items : [
                    ...
                    },
                    {
                      ...
                      labelAlign : 'right',
                      id : 'cboMedCirujanoEdit',
                      itemId : 'cboMedCirujanoEdit',
                      margin : '0 0 5 6',
                      store : storemedico,
                      queryMode : 'local',
                      valueField : 'id',
    ...
    Ext.Ajax.request({
      ...
      success : function(conn, response, options, eOpts) {
        ...
        Ext.each(result.items, function(item) {
          ...
          Ext.ComponentQuery.query('#cboMedCirujanoEdit')[0].setValue(item._idmedcirujano);
          Ext.ComponentQuery.query('#cboVendedorEdit')[0].setValue(item._idvendedor);
          Ext.ComponentQuery.query('#cboProveedorEdit')[0].setValue(item._idproveedor);
        ...
        Ext.Ajax.request({
          ...
          success : function(conn, response, options, eOpts) {
            ...
            store.sync();
            grid.getEl().unmask();
            Ext.getCmp('contratomodificar').getCalcularContrato();
          }
        });
      }
    });
      ...
      success : function(conn, response, options, eOpts) {
        ...
        if (result.success) {
          Ext.each(result.items, function(item) {
            ...
            ActualizarContratoDetalleModificar(item.ERROR, store);
          });
        } else {
...
function ActualizarContratoDetalleModificar(_idcontrato, _store) {
  ...
  fx_ContratoGuardarDetalleModificar(_idcontrato, idproductos, cantidades,
                                     medidas1, medidas2, totales, idmateriales,
                                     bobina, operario, obseritem, textoitem);
}
function fx_ContratoGuardarDetalleModificar(
